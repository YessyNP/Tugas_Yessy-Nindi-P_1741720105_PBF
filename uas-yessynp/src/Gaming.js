...
function LoginPage() {
  ...
  return (
    <Router>
      <div class="card-deck">
      <div class="card">
        <img class="card-img-top" src={g1} alt="Card image" />
        <div class="card-body">
          <ul>
          <h5 class="card-title">Republic Of Games</h5>
          <li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <ul>
          <h5 class="card-title">Micro Star Internasional</h5>
          <li>
            <Link to="/spesifikasi">SPESIFIKASI</Link>
          </li>
          <li>
 ...
 <div class="card">
        <img class="card-img-top" src={g4} alt="Card image cap" />
        <div class="card-body">
          <ul>
          <h5 class="card-title">Micro Star Internasional</h5>
          <li>
      ...
      <div class="card">
        <img class="card-img-top" src={g5} alt="Card image cap" />
...
function SPESIFIKASI() {
  ...
  return (
      ...
      <ul>
        ...
        <li>
          <Link to={`${url}/GP63-8RE-419`}>Processor</Link>
        </li>
        <li>
